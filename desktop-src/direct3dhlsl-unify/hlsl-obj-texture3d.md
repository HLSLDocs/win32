# HLSL Texture3D Object

Object for accessing a read-only 3D texture shader resource view.  See [SRV Textures](hlsl-resource-objects.md#srv-textures).
...
```HLSL
// prototype
template<typename ElementType = float4> class Texture3D;
