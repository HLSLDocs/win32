...
| [HLSL Current](./direct3dhlsl_current/hlsl-landing-page.md) | Current HLSL for Shader Model 6.0 and above is the high-level shader language for DirectX 12. Using HLSL, you can create C-like programmable shaders for the Direct3D pipeline. |
